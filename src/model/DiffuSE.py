...
class DiffuSE(nn.Module):
    ...
    def forward(self, x, c, t):
        ...
        out_deliver = self.c_deliver(c)

        x = self.preprocess(x, c)
        t = self.time_embedding(t)

        x, en_list = self.en(x, out_deliver['en_list'], t)  # [b,c,t,f], c=64, f=4
        ...
        x_real, de_real_list = self.de_real(x, en_list, out_deliver['de_real_list'], t)
        x_imag, de_imag_list = self.de_imag(x, en_list, out_deliver['de_imag_list'], t)
...
class Encoder(nn.Module):
    ...
    def forward(self, x, c_en_list, t):  # [b, 2, t, f]
        en_list = []
...
class Decoder(nn.Module):
    ...
    def forward(self, x, x_list, c_list, t):
        de_list = []
